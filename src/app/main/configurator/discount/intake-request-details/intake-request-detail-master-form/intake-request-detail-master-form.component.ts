...
export class IntakeRequestDetailMasterFormComponent implements OnInit {
 ...
 ngOnInit() {
  ...
  isAllSitesSelectedCheck() {
    if ((typeof this.addEditIntakeRequestMasterData.mapMarketList !== 'undefined') && (this.addEditIntakeRequestMasterData.mapMarketList !== null)) {
  ...
  isSitesExist(site) {
    let result = false;
    if ((typeof this.addEditIntakeRequestForm.projectMasterModel.sites !== 'undefined') && (this.addEditIntakeRequestForm.projectMasterModel.sites !== null)) {
      for (let i=0; i < this.addEditIntakeRequestForm.projectMasterModel.sites.length; i++) {
